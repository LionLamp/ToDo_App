...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFFF2F2F2);
  late Color tertiary = const Color(0xFFE5E5E5);
  late Color alternate = const Color(0xFFD9D9D9);
  late Color primaryText = const Color(0xFF000000);
  late Color secondaryText = const Color(0xFF222222);
  late Color primaryBackground = const Color(0xFFFFFFFF);
  late Color secondaryBackground = const Color(0xFFF2F2F2);
  late Color accent1 = const Color(0xFFCCCCCC);
  late Color accent2 = const Color(0xFFBFBFBF);
  late Color accent3 = const Color(0xFFA3A3A3);
  late Color accent4 = const Color(0xFF878787);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color accent1 = const Color(0xFF999999);
  late Color accent2 = const Color(0xFF888888);
  late Color accent3 = const Color(0xFF777777);
